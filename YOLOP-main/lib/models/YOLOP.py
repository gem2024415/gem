...
[ -1, Conv, [32, 64, 3, 2]],    #1
[ -1, BottleneckCSP, [64, 64, 1]],  #2
[ -1, Conv, [64, 128, 3, 2]],   #3 改正 kernel_size 2
[-1,MobileOne,[128,128,6,4,1,False]]
[ -1, BottleneckCSP, [128, 128, 3]],    #4
[ -1, Conv, [128, 256, 3, 2]],  #5
[ -1, BottleneckCSP, [256, 256, 3]],    #6
[ -1, Conv, [256, 512, 3, 2]],  #7 改正 kernel_size 2
[-1,  MobileOne,  [512,512,6,4,1,False]]
[ -1, SPP, [512, 512, [5, 9, 13]]],     #8
[ -1, BottleneckCSP, [512, 512, 1, False]],     #9
[ -1, Conv,[512, 256, 1, 1]],   #10 改正 kernel_size 1
[-1,  MobileOne,  [256,256,6,4,1,False]]
[ -1, Upsample, [None, 2, 'nearest']],  #11
[ [-1, 6], BiFPN_Add2, [1]],    #12
[ -1, BottleneckCSP, [512, 256, 1, False]], #13
[ -1, Conv, [256, 128, 1, 1]],  #14 改正 kernel_size 1
[-1,  MobileOne,  [128,128,6,4,1,False]]
[ -1, Upsample, [None, 2, 'nearest']],  #15
[ [-1,4], BiFPN_Add2, [1]],     #16         #Encoder

[ -1, BottleneckCSP, [256, 128, 1, False]],     #17
[ -1, Conv, [128, 128, 3, 2]],      #18
[ [-1, 14], BiFPN_Add2, [1]],       #19
[ -1, BottleneckCSP, [256, 256, 1, False]],     #20
[ -1, Conv, [256, 256, 3, 2]],      #21
[ [-1, 10], BiFPN_Add2, [1]],   #22
[ -1, BottleneckCSP, [512, 512, 1, False]],     #23
[-1,CA,[512,512]]
...
class MCnet(nn.Module):
    def __init__(self, block_cfg, **kwargs):
        ...
        for i, (from_, block, args) in enumerate(block_cfg[1:]):
            number=1
            block= block[1],number=block[0] if isinstance(block,list) else block
